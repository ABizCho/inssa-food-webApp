...
해당 프로젝트에 참여한 팀원 세명 모두 개발경험이 전무하며, 기초 프론트 & 백 학습경험을 가지고 있었다.<br/>
이러한 팀 구성의 특수성과 더불어, 작은 서비스여도 프론트-백-배포 까지의 모든 개발 스택과 경험을 온전히 경험해보고 싶었고, <br>
결정적으로 방학 중 2주라는 짧은 시간 내 빠른 호흡의 개발이 필요했다. 
<br/><br/>

이런 이유로 팀원들에게 요구사항 명세서를 기반으로 프론트-백에 이르는 기능단위별 무한책임 개발을 제안했고,<br>
팀원 모두 긍정적으로 받아들였기에, 모든 커버리지를 포함하는 풀스택 개발을 수행할 수 있었다.

짧은 호흡의 크런치에 기반한 협업방식이었기에, 짧게는 매일 길게는 이틀정도의 간격의 대면 회의를 가졌다.<br>
회의시 각자 담당기능 별 현황과 이슈를 공유하였고 새로운 태스크를 할당했으며, 충분한 페어프로그래밍의 시간을 가질 수 있었다.

<br><br>

이번 프로젝트를 결정하는 핵심 역할은 크게 나눠 세가지였다고 생각한다.<br>
...
<img width="250px" src="./Animation.gif">
